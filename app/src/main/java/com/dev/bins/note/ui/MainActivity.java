...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentManager.beginTransaction().replace(R.id.fragment,new TrashFragment()).commit();
            toolbar.setTitle("回收站");

        } else if (id == R.id.nav_slideshow) {
            fragmentManager.beginTransaction().replace(R.id.fragment,new ClipBoardFragment()).commit();
            toolbar.setTitle("剪切板");
